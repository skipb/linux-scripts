...
sudo apt-get install ssh ubuntu-restricted-extras ubuntu-restricted-addons build-essential git numix-gtk-theme numix-icon-theme-circle sublime-text-installer vlc python-gpgme ssh gimp
